...
- [ ] system wakes if AC is connected during sleep: pending firmware update, BIOS 03.05 [workaround via udev rules](https://community.frame.work/t/tracking-framework-amd-ryzen-7040-series-lid-wakeup-behavior-feedback/39128/45) (pending [kernel patch](https://lore.kernel.org/platform-driver-x86/20240410141046.433-1-mario.limonciello@amd.com/)), BIOS 03.03 workaround in [Linux >=6.7](https://github.com/torvalds/linux/commit/a55bdad5dfd1efd4ed9ffe518897a21ca8e4e193) (via [kernel patch](https://lore.kernel.org/platform-driver-x86/20231212045006.97581-1-mario.limonciello@amd.com/))
